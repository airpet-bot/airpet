...
async function initializeApp() {
    ...
    AIAssistant.init({
        ...
        getSelectionContext: () => buildAiSelectionContext(
...
async function handleGpsEditorConfirm(data) {
    ...
    if (data.isEdit) {
        ...
        try {
            ...
            const result = await APIService.updateParticleSource(
                sourceId,
                data.name,
                data.gps_commands,
                data.position,
        ...
        try {
            const result = await APIService.addParticleSource(
                data.name,
                data.gps_commands,
                data.position,
                data.rotation,
