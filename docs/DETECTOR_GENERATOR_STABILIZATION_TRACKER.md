...
- Overall phase: post-R3 stabilization loop, complete
...
None remaining. DGS-008 is complete and this tracker has no NEXT or PENDING items left.
...
| DGS-008 | P2 | Shared UX | Add shared generated-object selection or reveal affordances when they materially improve generator discoverability | DONE | Saved generator cards now expose a shared `Select Geometry` affordance that selects generated live placements or affected live placements for boolean-based generators |
...
| 2026-04-10 | DGS-008 shared generated-geometry selection affordance | DONE | Files: [`/Volumes/nvme/projects/airpet/static/detectorFeatureGeneratorsUi.js`](/Volumes/nvme/projects/airpet/static/detectorFeatureGeneratorsUi.js), [`/Volumes/nvme/projects/airpet/static/uiManager.js`](/Volumes/nvme/projects/airpet/static/uiManager.js), [`/Volumes/nvme/projects/airpet/static/main.js`](/Volumes/nvme/projects/airpet/static/main.js), [`/Volumes/nvme/projects/airpet/tests/js/detector_feature_generators_ui.test.mjs`](/Volumes/nvme/projects/airpet/tests/js/detector_feature_generators_ui.test.mjs), [`/Volumes/nvme/projects/airpet/docs/DETECTOR_GENERATOR_STABILIZATION_TRACKER.md`](/Volumes/nvme/projects/airpet/docs/DETECTOR_GENERATOR_STABILIZATION_TRACKER.md). Tests: `node --check static/detectorFeatureGeneratorsUi.js`; `node --check static/uiManager.js`; `node --check static/main.js`; `node --test tests/js/detector_feature_generators_ui.test.mjs`. Outcome: validated a remaining cross-generator discoverability gap by confirming saved generator cards still only exposed edit/regenerate actions, added a shared `Select Geometry` affordance that selects generated live placements when recorded and falls back to affected live placements for boolean-based generators, reused the existing hierarchy-selection flow with a generic error path, and added focused regressions for both placement-based and boolean-based selection contexts. Next: none |
