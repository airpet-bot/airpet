...
- Current priority: audit channel-cut array realization, target updates, and saved-generator revision behavior end to end
...
DGS-006: audit channel-cut array realization, target updates, and saved-generator revision behavior end to end.

Focus for this task:

- verify cut-result solids remain coherent after create and regenerate
- confirm targeted logical volumes update cleanly when the saved channel-cut spec changes
- keep the audit narrow to channel-cut arrays rather than broad cross-generator cleanup
...
| DGS-006 | P1 | Channel Cuts | Audit channel-cut array realization, target updates, and saved-generator revision behavior end to end | NEXT | Focus on cut-result visibility and target LV retargeting consistency |
