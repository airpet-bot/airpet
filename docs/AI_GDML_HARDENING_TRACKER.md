...
`GDML-002` Add parameterised solid import mapping for `trd_dimensions`.

Reason:
- highest-priority pending P1 after closing `AI-002`
...
| GDML-002 | P1 | GDML | Add parameterised solid import mapping for `trd_dimensions` | PENDING | Include parser tests and at least one representative import case |
| GDML-003 | P1 | GDML | Add parameterised solid import mapping for `trap_dimensions` | PENDING | Include parser tests and representative import case |
