...
| ACR-005 | P1 | Detector Generators | Add a Playwright create/undo/reload workflow for tiled sensor arrays and one boolean-cut generator | NEXT | Verify hierarchy, renderer, Solids panel, and stale-object cleanup |
