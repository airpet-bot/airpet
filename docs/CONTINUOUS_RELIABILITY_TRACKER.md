...
| ACR-006 | P1 | CAD | Add a compact CAD import/reimport browser workflow using small STEP fixtures | NEXT | Verify the CAD imports panel appears only when relevant and does not break narrow sidebars |
