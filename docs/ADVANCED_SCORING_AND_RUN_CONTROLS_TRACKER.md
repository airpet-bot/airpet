...
`ASRC-004`: add common tally support such as dose, fluence, or current on the shared scoring abstraction.
...
| ASRC-004 | P1 | Tallies | Add common tally support such as dose, fluence, or current on the shared scoring abstraction | NEXT | Reuse the scoring contract rather than adding one-off special cases |
