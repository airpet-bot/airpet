...
- Current priority: surface compact scoring result summaries and comparisons on top of the stronger run-manifest metadata
...
`ASRC-006`: add compact result-summary and multi-run comparison surfaces for scoring outputs.
...
| ASRC-006 | P2 | Analysis UX | Add compact result-summary and multi-run comparison surfaces for scoring outputs | NEXT | Start with deterministic summaries before richer plotting or visualization |
