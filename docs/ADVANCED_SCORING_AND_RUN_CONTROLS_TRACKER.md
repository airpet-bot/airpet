...
- Current priority: make scoring runs easier to audit and compare via stronger run manifests and artifact-bundle summaries
...
`ASRC-005`: add a run manifest and artifact-bundle summary that makes scoring runs easier to audit and compare.
...
| ASRC-005 | P1 | Reproducibility | Add a run manifest and artifact-bundle summary that makes scoring runs easier to audit and compare | NEXT | Include enough structured metadata to identify geometry, environment, scoring config, and output files |
