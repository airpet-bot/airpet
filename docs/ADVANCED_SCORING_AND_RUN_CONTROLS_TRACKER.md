...
- Current priority: add selected expert run controls that materially improve scoring workflows
...
`ASRC-008`: add selected expert run controls that materially improve scoring workflows.
...
| ASRC-008 | P2 | Expert Controls | Add selected expert run controls that materially improve scoring workflows | NEXT | Focus on controls that improve scoring usefulness rather than broad Geant4 option coverage |
