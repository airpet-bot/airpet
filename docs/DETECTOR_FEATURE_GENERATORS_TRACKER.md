...
- Current priority: tiled sensor-array workflows next
...
DFG-008: add a tiled sensor-array generator.

Focus for this task:

- focus on practical SiPM, strip, or pixel-style repeated sensor layouts
- reuse the new detector-generator saved-state and realization plumbing where practical
- keep the first slice narrow enough to expose a useful repeated-placement workflow without broad CAD-style editing
...
| DFG-008 | P2 | Generator | Add a tiled sensor-array generator | NEXT | Useful for SiPM, pixel, and strip-style layouts |
