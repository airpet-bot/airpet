...
DFG-004: add AI/backend tool surfaces for detector-feature-generator creation and inspection.

Focus for this task:

- keep the first AI/backend contract aligned with the saved-state and UI generator model
- expose narrow create/inspect surfaces instead of a broad generator-tool taxonomy
- preserve deterministic generator ids, target refs, and realization summaries for follow-on automation work
...
| DFG-004 | P1 | AI | Add AI/backend tool surfaces for detector-feature-generator creation and inspection | NEXT | Keep the first AI contract aligned with the saved-state and UI generator model |
