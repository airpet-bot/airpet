...
DFG-006: add compact example assets and regression fixtures for patterned-hole workflows.

Focus for this task:

- favor small deterministic fixtures over large CAD-like examples
- cover both rectangular and circular patterned-hole workflows with compact, reviewable assets or saved-state snippets
- keep the example surface narrow enough that it improves regression confidence without turning into a new generator-family task
...
| DFG-006 | P1 | Examples | Add compact example assets and regression fixtures for patterned-hole workflows | NEXT | Favor small deterministic fixtures over large CAD-like examples |
