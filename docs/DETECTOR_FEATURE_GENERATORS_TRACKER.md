...
- Current priority: layered detector-stack workflows next
...
DFG-007: add a layered detector-stack generator.

Focus for this task:

- focus on absorber/sensor/support sandwiches and repeated module stacks
- keep the first slice narrow enough to reuse existing solids, placements, and saved-generator patterns
- preserve explicit saved-state provenance so stack parameters can be revised without rebuilding the geometry by hand
...
| DFG-007 | P1 | Generator | Add a layered detector-stack generator | NEXT | Focus on absorber/sensor/support sandwiches and repeated module stacks |
